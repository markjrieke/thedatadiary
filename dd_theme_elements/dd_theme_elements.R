...
dd_theme <- theme(
  ...
  plot.caption = element_markdown(family = dd_font_light),
  legend.text = element_markdown(family = dd_font_light),
  legend.title = element_markdown(family = dd_font_light),
  axis.title = element_markdown(family = dd_font_light, color = dd_black),
  axis.text = element_markdown(family = dd_font_light, color = dd_black),
