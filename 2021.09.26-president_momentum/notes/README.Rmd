...
* finish out analysis
  ...
  * feature engineering
    ...
    * non-normally distributed features (e.g., % of populations)
      * maybe inverse sigmoid function (i.e., stretch values close to 0 out to infinity)
...
* rewrite so that it looks like a human wrote it lol
  * alternatively, write a less technically intense version for squarespace & link to the more technical version on github
